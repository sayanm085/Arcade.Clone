  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-sm max-w-xs">
              Create interactive product demos and tutorials with ease. No coding required.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between">
          <p className="text-gray-500 text-sm">
            © {currentYear} Arcade Software, Inc. All rights reserved.
          </p>
